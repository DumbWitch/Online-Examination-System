...
<jsp:useBean id="pDAO" class="demotest.DatabaseClass" scope="page"/>
			...
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						...
						<a class="active" href="studentpage.jsp?pgprt=1"><h2>Exams</h2></a>
						<a  href="studentpage.jsp?pgprt=2"><h2>Results</h2></a>
					</div>
				</div>
